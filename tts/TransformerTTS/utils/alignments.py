...
def get_durations_from_alignment(batch_alignments, mels, phonemes, weighted=False):
    ...
    for batch_num, al in enumerate(batch_alignments):
        ...
        '''
        print("Ref attention weights shape: {} | {}".format(ref_attention_weights.shape, ref_attention_weights))
        print("Integer durations length: {} | {}".format(len(integer_durations), integer_durations))
        print("=====")
        print("Mel length: {} | {}".format(len(mel_len), mel_len))
        print("=====")
